...
#' @param Field variable used to calculate entropy
#' @param GridSpace size in meters of the segmentation grid
#' @param GridType geometry of the grid (Sqr or Hex)
#' @param mode execute a final intersection with the provided Field 
#' 
#' @keywords Entropy
#' 
#' @return Sf object
#' 
#' @importFrom sf st_read st_make_grid st_sf
